...
module.exports = (numberOfDigits) => {
  ...
  for (let i = 0; i < thousandDigits.length - numberOfDigits - 1; i++) {
    let digits = thousandDigits.slice(i, i + numberOfDigits);
    let product = digits.reduce((total, current) => total * current);
